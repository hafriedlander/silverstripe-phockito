...
class PhockitoClassManifestUpdater extends SS_ClassManifest
{
    ...
    public function addDouble($double, $doubled, $isInterface = false)
    {
        ...
        if ($isInterface) {
            ...
            if (!isset($this->implementors[$lDoubled])) {
                $this->implementors[$lDoubled] = array();
            }
     ...
     */
    public static function register_double($double, $of, $isDoubleOfInterface = false)
    {
